...
```
tar -xf WaSPPipe-1.1.0-dev.tar.gz
```
#### Be sure to change the version number in the above command (1.1.0-dev in this example) to the version appropriate for your file.
...
```
nextflow run /path/to/WaSPPipe-1.1.0-dev/main.nf --fastq /path/to/fastq_pass/
```
...
```
nextflow run /path/to/WaSPPipe-1.1.0-dev/main.nf --fastq /path/to/fastq_pass/ --max_length 2000
```
