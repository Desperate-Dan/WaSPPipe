...
def coverage_calc(coverage_data):
    # Will read coverage data generated by maskara and calculate average coverage of non-zero sites
    coverage_dict = {}
...
def read_files(read_counts,name_dict,consensus_refs,comparison_dict,coverage_dict):
    ...
    combined_df['coverage_mean'] = coverage_mean
    combined_df['coverage_median'] = coverage_median
...
Examples:
  %(prog)s --reference_file references.fasta --consensus_files  "consensus_seq [...]" -r "read_counts.csv [...]"
    ...
    parser.add_argument(
            "--coverage_data",
            required=True,
            help="Lists of paths to coverage data for your sequences"
    )
    ...
    coverage_dict = coverage_calc(args.coverage_data)

    read_files(args.read_counts, name_dict, consensus_refs, comparison_dict, coverage_dict)
